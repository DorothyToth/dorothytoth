    ...
    return (
        <>
            ...
            <section id="categoryGrid">
                ...
                <div id="education" className="categoryGridArea">
                    ...
                    <div className="buttons">
                        <a href="files/CS-Dept-of-Ed-Website-Redesign.pdf" target="_blank"><button className="blue"><h6>case study</h6></button></a>
