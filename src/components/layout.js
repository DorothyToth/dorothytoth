		...
		<>
			<header>
				<nav className="nav-wrapper">
					...
					<div id="navigation">
						<Link className="navLink" href="#hero" onClick={ e => scrollToElement( e ) }><p>home</p></Link>
					...
					<Link className="navLink" href="#hero" onClick={ e => scrollToElement( e ) }><img id="upToTop" src="images/DT-carrot-grayUp.svg" /></Link>
